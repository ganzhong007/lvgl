/**
 * @file lv_evgpu_utils.h
 *
 */

#ifndef LV_EVGPU_UTILS_H
#define LV_EVGPU_UTILS_H
 ...
 * @param xform 6 floats from lv_evgpu_matrix_convert / lv_matrix layout
 */
static inline void lv_evgpu_xform_to_mat3(float * mat3_out, const float * xform)
{
...
/**
 * Prepare GL state before interleaved native GLES2 draws (after evgr flush).
 */
...
{
    return evgrRGBA(color.red, color.green, color.blue, opa);
}
