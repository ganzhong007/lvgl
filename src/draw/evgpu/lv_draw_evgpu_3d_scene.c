...
#if LV_USE_DRAW_EVGPU && LV_USE_3D_DRAW_TASKS && LV_USE_GLTF
...
void lv_draw_evgpu_3d_scene_init(void)
{
    ...
    s_scene_ready = true;
    LV_LOG_INFO("EVGPU 3D scene ready (SCENE pass + gltf dispatch)");
}
...
void lv_draw_evgpu_3d_scene(lv_draw_task_t * t, const lv_draw_3d_scene_dsc_t * dsc)
{
    ...
    if(!s_scene_ready) lv_draw_evgpu_3d_scene_init();
...
#endif /* LV_USE_DRAW_EVGPU && LV_USE_3D_DRAW_TASKS && LV_USE_GLTF */
