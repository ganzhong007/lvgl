/**
 * @file lv_evgpu_fbo_cache.h
 *
 */

#ifndef LV_EVGPU_FBO_CACHE_H
#define LV_EVGPU_FBO_CACHE_H
 ...
 */
struct _lv_cache_entry_t * lv_evgpu_fbo_cache_get(struct _lv_draw_evgpu_unit_t * u, int width, int height, int flags,
                                                   int format);
