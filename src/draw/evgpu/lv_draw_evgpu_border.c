...
static enum EVGRwinding path_append_inner_rect(EVGRcontext * ctx,
...
void lv_draw_evgpu_border(lv_draw_task_t * t, const lv_draw_border_dsc_t * dsc, const lv_area_t * coords)
{
    ...
    /* inner rect */
    enum EVGRwinding winding = path_append_inner_rect(u->evgr, dsc, coords->x1, coords->y1, w, h, r_out);
                                              ...
                                              float r)
{
    ...
    if(r_in <= 0) {
        ...
        if(dsc->side & LV_BORDER_SIDE_BOTTOM) {
            evgrMoveTo(ctx, p16_x, p16_y);
            evgrLineTo(ctx, p9_x, p9_y);
            evgrLineTo(ctx, p10_x, p10_y);
            lv_evgpu_path_append_arc_right_angle(ctx, p10_x, p10_y, c3_x, c3_y, p11_x, p11_y);
            evgrLineTo(ctx, p14_x, p14_y);
            lv_evgpu_path_append_arc_right_angle(ctx, p14_x, p14_y, c4_x, c4_y, p15_x, p15_y);
            evgrClosePath(ctx);
        }

        if(dsc->side & LV_BORDER_SIDE_TOP) {
            evgrMoveTo(ctx, p1_x, p1_y);
            evgrLineTo(ctx, p2_x, p2_y);
            lv_evgpu_path_append_arc_right_angle(ctx, p2_x, p2_y, c1_x, c1_y, p3_x, p3_y);
            evgrLineTo(ctx, p6_x, p6_y);
            lv_evgpu_path_append_arc_right_angle(ctx, p6_x, p6_y, c2_x, c2_y, p7_x, p7_y);
            evgrLineTo(ctx, p8_x, p8_y);
            evgrClosePath(ctx);
        }

        if(dsc->side & LV_BORDER_SIDE_LEFT) {
            evgrMoveTo(ctx, p4_x, p4_y);
            evgrLineTo(ctx, p13_x, p13_y);
            evgrLineTo(ctx, p14_x, p14_y);
            lv_evgpu_path_append_arc_right_angle(ctx, p14_x, p14_y, c4_x, c4_y, p15_x, p15_y);
            evgrLineTo(ctx, p2_x, p2_y);
            lv_evgpu_path_append_arc_right_angle(ctx, p2_x, p2_y, c1_x, c1_y, p3_x, p3_y);
        ...
        if(dsc->side & LV_BORDER_SIDE_RIGHT) {
            evgrMoveTo(ctx, p5_x, p5_y);
            evgrLineTo(ctx, p6_x, p6_y);
            lv_evgpu_path_append_arc_right_angle(ctx, p6_x, p6_y, c2_x, c2_y, p7_x, p7_y);
            evgrLineTo(ctx, p10_x, p10_y);
            lv_evgpu_path_append_arc_right_angle(ctx, p10_x, p10_y, c3_x, c3_y, p11_x, p11_y);
            evgrLineTo(ctx, p12_x, p12_y);
            evgrClosePath(ctx);
        }
    ...
    /* r^2 - r_in^2 = offset^2 */
    const float offset = EVGR_MATH_SQRTF((2 * r - border_w) * border_w);
    const float sweep_alpha = EVGR_MATH_DEGREES(EVGR_MATH_ACOSF(r_in / r));
    ...
    if(dsc->side & LV_BORDER_SIDE_BOTTOM) {
        evgrMoveTo(ctx, p21_x, p21_y);
        evgrLineTo(ctx, p16_x, p16_y);
        lv_evgpu_path_append_arc(ctx, c3_x, c3_y, r, sweep_beta, sweep_alpha, false);
        evgrLineTo(ctx, p20_x, p20_y);
        lv_evgpu_path_append_arc(ctx, c4_x, c4_y, r, 90, sweep_alpha, false);
        evgrClosePath(ctx);
    }

    if(dsc->side & LV_BORDER_SIDE_TOP) {
        evgrMoveTo(ctx, p4_x, p4_y);
        lv_evgpu_path_append_arc(ctx, c1_x, c1_y, r, 270 - sweep_alpha, sweep_alpha, false);
        evgrLineTo(ctx, p8_x, p8_y);
        lv_evgpu_path_append_arc(ctx, c2_x, c2_y, r, 270, sweep_alpha, false);
        evgrClosePath(ctx);
    }

    if(dsc->side & LV_BORDER_SIDE_LEFT) {
        evgrMoveTo(ctx, p3_x, p3_y);
        evgrLineTo(ctx, p22_x, p22_y);
        lv_evgpu_path_append_arc(ctx, c4_x, c4_y, r, 90 + sweep_beta, sweep_alpha, false);
        evgrLineTo(ctx, p2_x, p2_y);
        lv_evgpu_path_append_arc(ctx, c1_x, c1_y, r, 180, sweep_alpha, false);
        evgrClosePath(ctx);
    }

    if(dsc->side & LV_BORDER_SIDE_RIGHT) {
        evgrMoveTo(ctx, p10_x, p10_y);
        lv_evgpu_path_append_arc(ctx, c2_x, c2_y, r, 270 + sweep_beta, sweep_alpha, false);
        evgrLineTo(ctx, p14_x, p14_y);
        lv_evgpu_path_append_arc(ctx, c3_x, c3_y, r, 0, sweep_alpha, false);
        evgrClosePath(ctx);
    }
    ...
    if(HAS_BORDER_SIDE(dsc->side, LV_BORDER_SIDE_TOP | LV_BORDER_SIDE_LEFT)) {
        evgrMoveTo(ctx, p2_x, p2_y);
        lv_evgpu_path_append_arc_right_angle(ctx, p2_x, p2_y, c1_x, c1_y, p5_x, p5_y);
        evgrLineTo(ctx, p6_x, p6_y);
        lv_evgpu_path_append_arc_right_angle(ctx, p6_x, p6_y, c1_x, c1_y, p1_x, p1_y);
        evgrClosePath(ctx);
    }

    if(HAS_BORDER_SIDE(dsc->side, LV_BORDER_SIDE_TOP | LV_BORDER_SIDE_RIGHT)) {
        evgrMoveTo(ctx, p8_x, p8_y);
        lv_evgpu_path_append_arc_right_angle(ctx, p8_x, p8_y, c2_x, c2_y, p11_x, p11_y);
        evgrLineTo(ctx, p12_x, p12_y);
        lv_evgpu_path_append_arc_right_angle(ctx, p12_x, p12_y, c2_x, c2_y, p7_x, p7_y);
        evgrClosePath(ctx);
    }

    if(HAS_BORDER_SIDE(dsc->side, LV_BORDER_SIDE_BOTTOM | LV_BORDER_SIDE_LEFT)) {
        evgrMoveTo(ctx, p20_x, p20_y);
        lv_evgpu_path_append_arc_right_angle(ctx, p20_x, p20_y, c4_x, c4_y, p23_x, p23_y);
        evgrLineTo(ctx, p24_x, p24_y);
        lv_evgpu_path_append_arc_right_angle(ctx, p24_x, p24_y, c4_x, c4_y, p19_x, p19_y);
        evgrClosePath(ctx);
    }

    if(HAS_BORDER_SIDE(dsc->side, LV_BORDER_SIDE_BOTTOM | LV_BORDER_SIDE_RIGHT)) {
        evgrMoveTo(ctx, p14_x, p14_y);
        lv_evgpu_path_append_arc_right_angle(ctx, p14_x, p14_y, c3_x, c3_y, p17_x, p17_y);
        evgrLineTo(ctx, p18_x, p18_y);
        lv_evgpu_path_append_arc_right_angle(ctx, p18_x, p18_y, c3_x, c3_y, p13_x, p13_y);
        evgrClosePath(ctx);
    }
