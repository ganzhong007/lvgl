/**
 * @file lv_gpu_composite_batch_3d.h — 3D draw-item material batch helpers
 */

#ifndef LV_GPU_COMPOSITE_BATCH_3D_H
#define LV_GPU_COMPOSITE_BATCH_3D_H
...
#endif /*LV_GPU_COMPOSITE_BATCH_3D_H*/
