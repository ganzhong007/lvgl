/**
 * @file lv_g100_utils.h
 *
 */

#ifndef LV_G100_UTILS_H
#define LV_G100_UTILS_H
 ...
 */
void lv_g100_utils_init(struct _lv_draw_g100_unit_t * u);

/**
 * Deinitialize NanoVG utilities
 * @param u pointer to the nanovg unit
 */
void lv_g100_utils_deinit(struct _lv_draw_g100_unit_t * u);
 ...
 */
static inline void lv_g100_matrix_convert(float * xform, const lv_matrix_t * matrix)
{
 ...
 */
static inline NVGcolor lv_g100_color_convert(lv_color_t color, lv_opa_t opa)
{
 ...
 */
void lv_g100_transform(NVGcontext * ctx, const lv_matrix_t * matrix);
 ...
 * @param area the area
 */
void lv_g100_path_append_area(NVGcontext * ctx, const lv_area_t * area);
 ...
 */
void lv_g100_path_append_arc_right_angle(NVGcontext * ctx,
 ...
 */
void lv_g100_path_append_arc(NVGcontext * ctx,
                               float cx, float cy,
                               float radius,
                               float start_angle,
                               float sweep,
 ...
 */
void lv_g100_fill(NVGcontext * ctx, enum NVGwinding winding, enum NVGcompositeOperation composite_operation,
                    NVGcolor color);
 ...
 * @param u pointer to the nanovg unit
 */
void lv_g100_end_frame(struct _lv_draw_g100_unit_t * u);

/**
 * Clean up the NanoVG unit (e.g. at the end of task)
 * @param u pointer to the nanovg unit
 */
void lv_g100_clean_up(struct _lv_draw_g100_unit_t * u);
 ...
 */
lv_draw_buf_t * lv_g100_reshape_global_image(struct _lv_draw_g100_unit_t * u,
