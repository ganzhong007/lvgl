...
void lv_draw_g100_border(lv_draw_task_t * t, const lv_draw_border_dsc_t * dsc, const lv_area_t * coords)
{
    ...
    lv_g100_fill(
        ...
        winding,
        NVG_SOURCE_OVER,
        lv_g100_color_convert(dsc->color, dsc->opa));
                                              ...
                                              float r)
{
    ...
    if(r_in <= 0) {
        ...
        if(dsc->side & LV_BORDER_SIDE_BOTTOM) {
            ...
            lv_g100_path_append_arc_right_angle(ctx, p10_x, p10_y, c3_x, c3_y, p11_x, p11_y);
            nvgLineTo(ctx, p14_x, p14_y);
            lv_g100_path_append_arc_right_angle(ctx, p14_x, p14_y, c4_x, c4_y, p15_x, p15_y);
            nvgClosePath(ctx);
        }
        ...
        if(dsc->side & LV_BORDER_SIDE_TOP) {
            ...
            lv_g100_path_append_arc_right_angle(ctx, p2_x, p2_y, c1_x, c1_y, p3_x, p3_y);
            nvgLineTo(ctx, p6_x, p6_y);
            lv_g100_path_append_arc_right_angle(ctx, p6_x, p6_y, c2_x, c2_y, p7_x, p7_y);
    ...
    if(dsc->side & LV_BORDER_SIDE_BOTTOM) {
        ...
        lv_g100_path_append_arc(ctx, c3_x, c3_y, r, sweep_beta, sweep_alpha, false);
        nvgLineTo(ctx, p20_x, p20_y);
        lv_g100_path_append_arc(ctx, c4_x, c4_y, r, 90, sweep_alpha, false);
        nvgClosePath(ctx);
    }

    if(dsc->side & LV_BORDER_SIDE_TOP) {
        nvgMoveTo(ctx, p4_x, p4_y);
        lv_g100_path_append_arc(ctx, c1_x, c1_y, r, 270 - sweep_alpha, sweep_alpha, false);
        nvgLineTo(ctx, p8_x, p8_y);
        lv_g100_path_append_arc(ctx, c2_x, c2_y, r, 270, sweep_alpha, false);
        nvgClosePath(ctx);
    }
    ...
    if(dsc->side & LV_BORDER_SIDE_LEFT) {
        ...
        lv_g100_path_append_arc(ctx, c4_x, c4_y, r, 90 + sweep_beta, sweep_alpha, false);
        nvgLineTo(ctx, p2_x, p2_y);
        lv_g100_path_append_arc(ctx, c1_x, c1_y, r, 180, sweep_alpha, false);
        nvgClosePath(ctx);
    }

    if(dsc->side & LV_BORDER_SIDE_RIGHT) {
        nvgMoveTo(ctx, p10_x, p10_y);
        lv_g100_path_append_arc(ctx, c2_x, c2_y, r, 270 + sweep_beta, sweep_alpha, false);
        nvgLineTo(ctx, p14_x, p14_y);
        lv_g100_path_append_arc(ctx, c3_x, c3_y, r, 0, sweep_alpha, false);
        nvgClosePath(ctx);
    }
    ...
    if(HAS_BORDER_SIDE(dsc->side, LV_BORDER_SIDE_TOP | LV_BORDER_SIDE_LEFT)) {
        ...
        lv_g100_path_append_arc_right_angle(ctx, p2_x, p2_y, c1_x, c1_y, p5_x, p5_y);
        nvgLineTo(ctx, p6_x, p6_y);
        lv_g100_path_append_arc_right_angle(ctx, p6_x, p6_y, c1_x, c1_y, p1_x, p1_y);
        nvgClosePath(ctx);
    }

    if(HAS_BORDER_SIDE(dsc->side, LV_BORDER_SIDE_TOP | LV_BORDER_SIDE_RIGHT)) {
        nvgMoveTo(ctx, p8_x, p8_y);
        lv_g100_path_append_arc_right_angle(ctx, p8_x, p8_y, c2_x, c2_y, p11_x, p11_y);
        nvgLineTo(ctx, p12_x, p12_y);
        lv_g100_path_append_arc_right_angle(ctx, p12_x, p12_y, c2_x, c2_y, p7_x, p7_y);
        nvgClosePath(ctx);
    }

    if(HAS_BORDER_SIDE(dsc->side, LV_BORDER_SIDE_BOTTOM | LV_BORDER_SIDE_LEFT)) {
        nvgMoveTo(ctx, p20_x, p20_y);
        lv_g100_path_append_arc_right_angle(ctx, p20_x, p20_y, c4_x, c4_y, p23_x, p23_y);
        nvgLineTo(ctx, p24_x, p24_y);
        lv_g100_path_append_arc_right_angle(ctx, p24_x, p24_y, c4_x, c4_y, p19_x, p19_y);
        nvgClosePath(ctx);
    }

    if(HAS_BORDER_SIDE(dsc->side, LV_BORDER_SIDE_BOTTOM | LV_BORDER_SIDE_RIGHT)) {
        nvgMoveTo(ctx, p14_x, p14_y);
        lv_g100_path_append_arc_right_angle(ctx, p14_x, p14_y, c3_x, c3_y, p17_x, p17_y);
        nvgLineTo(ctx, p18_x, p18_y);
        lv_g100_path_append_arc_right_angle(ctx, p18_x, p18_y, c3_x, c3_y, p13_x, p13_y);
        nvgClosePath(ctx);
    }
