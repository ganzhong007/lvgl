...
#if (LV_USE_DRAW_EVGPU_C_R_T) && LV_USE_3DTEXTURE
...
void lv_draw_evgpu_c_r_t_3d(lv_draw_task_t * t, const lv_draw_3d_dsc_t * dsc, const lv_area_t * coords)
{
    ...
    /* Flush C_R_T GL batch before direct OpenGL 3D texture blit */
...
#endif /* LV_USE_DRAW_EVGPU_C_R_T && LV_USE_3DTEXTURE */
