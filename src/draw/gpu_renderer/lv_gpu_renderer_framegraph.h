/**
 * @file lv_gpu_composite_framegraph.h — Record / build / execute frame passes
 */

#ifndef LV_GPU_COMPOSITE_FRAMEGRAPH_H
#define LV_GPU_COMPOSITE_FRAMEGRAPH_H
...
/**
 * Score for evaluate: lower = gpu_composite prefers this task (LVGL convention).
...
bool lv_gpu_composite_fg_queue_2d_task(lv_draw_task_t * task);
...
#endif /*LV_GPU_COMPOSITE_FRAMEGRAPH_H*/
