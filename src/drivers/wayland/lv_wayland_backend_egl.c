...
#if LV_USE_DRAW_OPENGLES || LV_USE_DRAW_NANOVG || LV_USE_DRAW_EVGPU
...
static void * wl_egl_init_display(void * backend_ctx, lv_display_t * display, int32_t width, int32_t height)
{
    ...
    lv_display_set_render_mode(display, (LV_USE_DRAW_NANOVG || LV_USE_DRAW_EVGPU) ? LV_DISPLAY_RENDER_MODE_FULL : LV_DISPLAY_RENDER_MODE_DIRECT);
