/**
 * @file lv_test_conf_evgpu.h
 * Unity OPTIONS_TEST_EVGPU: DrawUnit EVGPU vs SW ref_imgs/.
 * Include AFTER lv_test_conf_full.h so these overrides win.
 */
#ifndef LV_TEST_CONF_EVGPU_H
#define LV_TEST_CONF_EVGPU_H
...
#define LV_USE_DRAW_EVGPU 1

#undef LV_USE_EVGPU_LIB
...
/* Keep SW as fallback for unclaimed tasks (e.g. MASK_BITMAP). */
